...
import qualified Kuza.OnChain.KuzaProjects as OnChain
...
main = defaultMain $ do
    testGroup
      ...
      [ testProperty "Anything after the deadline always fails        " prop_After_Fails
...
setUpProject :: OnChain.ProjectParams
setUpProject = 
...
-- All redeemers fail after deadline 
prop_After_Fails :: POSIXTime -> Integer -> Property
prop_After_Fails d r = (d > 1001) ==> runChecks False d r
